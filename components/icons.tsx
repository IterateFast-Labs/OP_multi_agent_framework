...
export const TestTubeDiagonalIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M14.5 2.5 16.5 4.5" />
        <path d="m21.03 7.53-1.5-1.5" />
        <path d="m7.53 21.03-1.5-1.5" />
        <path d="M4.5 16.5 2.5 14.5" />
        <path d="m17.5 1.5-15 15" />
        <path d="M22 7h-4" />
        <path d="M7 22v-4" />
    </svg>
);
